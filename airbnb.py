...
st.set_page_config(page_title= "Airbnb Data Visualization | By sugan",
                #    page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *sugan*!
...
df = pd.read_csv('C:\\Users\\DRACO\\Desktop\\All_VS_Code_Files\\Capstone Project file\\eda project\\Airbnb_data.csv')
